...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <asp:TextBox ID="txtTitulo" runat="server" placeholder="Ej: 1750928127" CssClass="form-control"></asp:TextBox>
            
        </div>
        <div class="form-group">
            <asp:Label ID="lblDescripcion" runat="server" Text="Descripcion Obra:" CssClass="form-label"></asp:Label>
            <asp:TextBox ID="txtDescripcion" runat="server" placeholder="Ej: Michael Llumiugsi" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="form-group">
